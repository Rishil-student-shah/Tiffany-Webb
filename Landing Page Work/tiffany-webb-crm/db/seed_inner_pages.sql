...
(@page_home, 'who_can_benefit', 'conferences-associations', 'Conferences & Professional Associations', 'Keynotes & Summits', '01 // CONFERENCES', NULL, '/work-with-tiffany?audience=Conferences', NULL, 'Keynotes, breakout sessions, and expert panels for national summits, annual conferences, and professional associations.', 1, 1),
(@page_home, 'who_can_benefit', 'schools-youth', 'Schools & Youth Organizations', 'Youth & Schools', '02 // YOUTH & SCHOOLS', NULL, '/work-with-tiffany?audience=Schools', NULL, 'Age-appropriate youth prevention, interactive workshops, and family engagement around digital risk and healthy choices.', 2, 1),
(@page_home, 'who_can_benefit', 'colleges-universities', 'Colleges & Universities', 'Higher Education', '03 // HIGHER ED', NULL, '/work-with-tiffany?audience=Colleges', NULL, 'Campus-wide wellness activations, athletic department sessions, student affairs programming, and Greek life dialogues.', 3, 1),
(@page_home, 'who_can_benefit', 'healthcare-hospitals', 'Healthcare & Hospital Systems', 'Clinical Networks', '04 // HEALTHCARE', NULL, '/work-with-tiffany?audience=Healthcare', NULL, 'Hospitals, primary care networks, clinical teams, and health systems integrating validated gambling screening protocols.', 4, 1),
(@page_home, 'who_can_benefit', 'government-public-health', 'Government & Public Health', 'Public Health', '05 // PUBLIC HEALTH', NULL, '/work-with-tiffany?audience=Government', NULL, 'Municipal health agencies, public health departments, county boards, and prevention policy task forces.', 5, 1),
(@page_home, 'who_can_benefit', 'behavioral-health', 'Behavioral Health Providers', 'Clinicians & Counselors', '06 // CLINICIANS', NULL, '/work-with-tiffany?audience=Behavioral+Health', NULL, 'Clinicians, addiction counselors, social workers, and mental health frontline teams managing co-occurring risks.', 6, 1),
(@page_home, 'who_can_benefit', 'recovery-networks', 'Recovery Networks', 'Peer Support & RCOs', '07 // RECOVERY', NULL, '/work-with-tiffany?audience=Recovery+Networks', NULL, 'Peer-support organizations, recovery community organizations (RCOs), and grassroots harm-reduction initiatives.', 7, 1),
(@page_home, 'who_can_benefit', 'rosc-coalitions', 'Community Coalitions & ROSC Councils', 'ROSC & Prevention', '08 // COALITIONS', NULL, '/work-with-tiffany?audience=ROSC+Councils', NULL, 'Recovery Oriented Systems of Care (ROSC) councils, prevention coalitions, and regional cross-sector partnerships.', 8, 1),
(@page_home, 'who_can_benefit', 'community-nonprofits', 'Community Organizations & Nonprofits', 'Nonprofits & Health Centers', '09 // NONPROFITS', NULL, '/work-with-tiffany?audience=Community+Nonprofits', NULL, 'Mission-driven neighborhood groups, civic organizations, and community health centers serving local families.', 9, 1),
(@page_home, 'who_can_benefit', 'faith-communities', 'Faith Communities', 'Churches & Ministries', '10 // FAITH', NULL, '/work-with-tiffany?audience=Faith+Communities', NULL, 'Churches, ministries, faith networks, and faith-based community outreach programs offering compassionate support.', 10, 1),
